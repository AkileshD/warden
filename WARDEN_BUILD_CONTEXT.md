...
- **Phase 3 Prerequisite:** The Correlation Gap (no shared action/session ID linking shell events to network events) — `WARDEN_SPEC.md §7.4`. Recommended to be addressed alongside Phase 3's detection component, not deferred indefinitely.
